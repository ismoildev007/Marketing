                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('services.update', $service->id) }}" method="POST">
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="nameInput" placeholder="Service Name"
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="number" class="form-control" id="priceInput"
                                            ...
                                            value="{{ $service->startingPrice }}" step="0.01" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea class="form-control" id="descriptionInput" placeholder="Description" name="description" rows="4"
