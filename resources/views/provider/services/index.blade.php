                        ...
                        <div class="card-body">
                            ...
                            <div class="card stretch stretch-full">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($service->skills->isNotEmpty())
                                                            @foreach ($service->skills->reverse()->take(2) as $skill)
                                                                <span
                                                                    class="badge bg-secondary">{{ $skill->name_en ?? $skill->name }}</span>
                                                            @endforeach
                                                        @else
                                                            <em>Нет навыков</em>
                                                        @endif
                                ...
                                <a href="javascript:void(0);"
                                    ...
                                    data-bs-toggle="offcanvas" data-bs-target="#addServiceModal">
