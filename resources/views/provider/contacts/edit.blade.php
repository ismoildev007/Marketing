                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('contacts.update', $contact->id) }}" method="POST">
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="phoneInput" placeholder="Phone Number" name="phone_number" value="{{ $contact->phone_number }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="email" class="form-control" id="emailInput" placeholder="Email" name="email" value="{{ $contact->email }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="linkInput" placeholder="Link" name="link" value="{{ $contact->link }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="locationInput" placeholder="Location" name="location" value="{{ $contact->location }}">
                                    </div>
                                </div>
