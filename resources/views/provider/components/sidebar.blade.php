<nav class="nxl-navigation">
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="/public" class="b-brand d-flex justify-content-center">
                <!-- ========   change your logo hear   ============ -->
                <img src="/assets/imgs/template/marketing-black.png" alt="" class="logo logo-lg w-75">
                <img src="/assets/imgs/template/favicon.svg" alt="" class="logo logo-sm  w-75">
            </a>
        </div>
            ...
            <ul class="nxl-navbar">
                ...
                <li class="nxl-item nxl-hasmenu {{ request()->is('provider/providers') ? 'active' : '' }}">
                    <a href="{{ route('providers.profile') }}" class="nxl-link">
                        <span class="nxl-micon">
                            <i
                                class="{{ request()->is('provider/providers') ? 'fa-solid fa-building' : 'fa-regular fa-building' }}"></i>
                        </span>
