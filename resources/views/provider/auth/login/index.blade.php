                    ...
                    <div class="box-form-register">
                        ...
                        <form class="form-register" method="POST" action="{{ route('provider.login') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="manager_email" required>
                            </div>
                            <div class="form-group">
                                <label>Ваш пароль <span class="brand-1">*</span></label>
                                <input class="form-control" name="manager_password" type="password" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="other-login">
                                <p class="text-md neutral-500">Нет аккаунта? &nbsp;<a class="brand-1-1" href="{{ route('providerRegisterStep1') }}">Зарегистрироваться</a></p>
                            </div>
                        </form>
                    </div>
                </div>
