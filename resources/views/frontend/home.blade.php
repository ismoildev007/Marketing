...
@section('description',
    'Маркетинговая Ассоциация Узбекистана. Цель Ассоциации: объединение юридических лиц и экспертов,
    заинтересованных в развитии маркетинга в Узбекистане, представление профессиональных интересов, совершенствование
    профессиональных норм и развитие кадрового потенциала маркетинговой отрасли.')
@section('content')
    <main class="main">
                    ...
                    <div class="container">
                        ...
                        <div class="box-banner-left">
                            ...
                            <p class="text-lg neutral-500 mb-55">
                                Добро пожаловать в крупнейшее бизнес-сообщество Центральной Азии! Мы объединяем тех, кто
                                развивает бизнес в Узбекистане с помощью маркетинга.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="section-box wow animate__animated animate__fadeIn box-how-it-work">
            <div class="container">
                <h2 class="mt-35 mb-15 text-center">Легко и быстро найдите<br class="d-none d-lg-block"> надежных
                    поставщиков услуг</h2>
                <p class="text-lg neutral-500 mb-45 text-center">Найдите профессионалов, которые идеально подойдут для
                    вашего бизнеса. Маркетинг, IT, дизайн и многое <br /> другое – все лучшие услуги на одной платформе.
                    Достигайте своих целей с нами!</p>
                <div class="row">
                                        ...
                                        <div class="card-desc">
                                            @if ($category->subCategories->isNotEmpty())
                                                @foreach ($category->subCategories as $service)
                                                    <a
                                                        href="{{ route('services-providers', [$service->id, $category->id]) }}">
                                                        {{-- {{ route('services-providers', [$service->id, $category->id]) }} --}}
                                                        <span>{{ $service->name_ru }} </span><i
            ...
            <div class="container mt-25">
                <a href="https://www.youtube.com/c/MAKONMARKETINGUZ" class="box-newsletter mb-0"
                    style="background-image: url('assets/imgs/newsletterimage.webp'); background-size: cover; height: 347px;">
                </a>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5 mb-40">
                        ...
                        <h1 class="heading-1 neutral-0">Доверие более 7,442 компаний</h1>
                    </div>
                                        ...
                                        <div class="carouselTicker3 carouselTicker_vertical" id="slide-top-award">
                                            <ul class="carouselTicker__list">
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img
                                                            src="assets/imgs/page/homepage6/glossy.png" alt="Nivia">
                                                    </div>
                                                </li>
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img src="assets/imgs/page/homepage6/ipsum.png"
                                                            alt="Nivia"></div>
                                                </li>
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img src="assets/imgs/page/homepage6/leafe.png"
                                                            alt="Nivia"></div>
                                                </li>
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img
                                                            src="assets/imgs/page/homepage6/pinpoint.png" alt="Nivia">
                                                    </div>
                                                </li>
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img src="assets/imgs/page/homepage6/minty.png"
                                                            alt="Nivia"></div>
                                                </li>
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img
                                    ...
                                    <div class="slider-award-2">
                                        <div class="carouselTicker4 carouselTicker_vertical" id="slide-bottom-award">
                                            <ul class="carouselTicker__list">
                                                ...
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img
                                                            src="assets/imgs/page/homepage6/ipsum.png" alt="Nivia">
                                                    </div>
                                                </li>
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img
                                                            src="assets/imgs/page/homepage6/leafe.png" alt="Nivia">
                                                    </div>
                                                </li>
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img
                                                ...
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img
                                                            src="assets/imgs/page/homepage6/sitemark.png" alt="Nivia">
                                                    </div>
                                                </li>
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img
                                    ...
                                    <div class="slider-award-3">
                                        <div class="carouselTicker5 carouselTicker_vertical" id="slide-top-award-2">
                                            <ul class="carouselTicker__list">
                                                ...
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img
                                                            src="assets/imgs/page/homepage6/minty.png" alt="Nivia">
                                                    </div>
                                                </li>
                                                <li class="carouselTicker__item">
                                                    <div class="item-logo-2"><img
        ...
        <section class="section-box wow animate__animated animate__fadeIn box-preparing-3 py-5">
            <div class="container">
                <div class="text-center">
                    ...
                    <p class="text-lg neutral-700">Крупнейшая маркетинговая платформа в <br /> Узбекистане – надежный
                        источник эффективных решений.</p>
                </div>
                <div class="row mt-90">
                    <div class="col-lg-6 col-md-6">
                        <div class="card-preparing-2"><a class="card-image" href="#!">
                                <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium text-client-500 bg-client-200 p-8 rounded-lg css-vubbuv"
                                    focusable="false" aria-hidden="true" viewBox="0 0 24 24"
                                    data-testid="EmojiObjectsTwoToneIcon" style="font-size:2.5rem">
                            ...
                            <div class="card-info"><a href="#!">
                                    <h5 class="text-22-bold">Современные данные и технологии AI</h5>
                                </a>
                                <p class="text-md neutral-700">Наши обширные и точные данные о рынке помогают принимать
                                    правильные решения. Найдите подходящего поставщика услуг, чтобы продвинуть свой бизнес.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="card-preparing-2"><a class="card-image" href="#!">
                                <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium text-client-500 bg-client-200 p-8 rounded-lg css-vubbuv"
                                    focusable="false" aria-hidden="true" viewBox="0 0 24 24"
                                    data-testid="HandshakeTwoToneIcon" style="font-size:2.5rem">
                                    <path
                            ...
                            <div class="card-info"><a href="#!">
                                    <h5 class="text-22-bold">Доказанная эффективность</h5>
                                </a>
                                <p class="text-md neutral-700">
                                    Ежедневно тысячи бизнесов в Узбекистане достигают новых успехов с помощью наших
                                    поставщиков услуг. Простота и эффективность нашего процесса – ключ к вашему росту.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="card-preparing-2"><a class="card-image" href="#!">
                                <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium text-client-500 bg-client-200 p-8 rounded-lg css-vubbuv"
                                    focusable="false" aria-hidden="true" viewBox="0 0 24 24"
                                    data-testid="BoltTwoToneIcon" style="font-size:2.5rem">
                                    <path
                            ...
                            <div class="card-info">
                                ...
                                <p class="text-md neutral-700">
                                    Мы помогаем вам за несколько минут найти поставщиков, соответствующих вашим потребностям
                                    и критериям. Это легко и удобно.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="card-preparing-2"><a class="card-image" href="#!">
                                <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium text-client-500 bg-client-200 p-8 rounded-lg css-vubbuv"
                                    focusable="false" aria-hidden="true" viewBox="0 0 24 24"
                                    data-testid="EmojiPeopleTwoToneIcon" style="font-size:40px">
                            ...
                            <div class="card-info"><a href="#!">
                                    <h5 class="text-22-bold">Человеческий подход</h5>
                                </a>
                                <p class="text-md neutral-700">Опытные специалисты Ассоциации Маркетинга Узбекистана всегда
                                    готовы помочь вам на каждом этапе. Мы объединяем возможности современных технологий с
                                    теплотой человеческого взаимодействия.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="section-box wow animate__animated animate__fadeIn box-our-track box-our-track-3">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 text-center mb-40"><img src="assets/imgs/dora/provider-section.webp"
                            alt="DORA"></div>
                    <div class="col-lg-6 mb-40">
                        <div class="box-padding-left-50">
                            ...
                            <p class="text-lg neutral-700">
                                ...
                                <br><br>
                                Мы связываем вас с подходящими клиентами и помогаем донести ваши услуги до широкой
                                аудитории. С нашей платформой вы достигаете быстрых и эффективных результатов.
                            </p>
                            <div class="row mt-50">
                                <div class="col-lg-6 col-sm-6">
                                    <div class="card-feature-2">
                                        <div class="card-image"><img src="assets/imgs/page/homepage3/marketing.svg"
                                                alt="DORA"></div>
                                        <div class="card-info"><a href="#">
                                                <h3 class="text-16-bold">Широкая аудитория</h3>
                                            </a>
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="card-feature-2">
                                        ...
                                        <div class="card-info"><a href="#">
                                                <h3 class="text-16-bold">Анализ и отслеживание</h3>
                                            </a>
                                            <p class="text-md neutral-700">Получайте полезные данные для оценки вашей
                                                эффективности</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6">
                                    <div class="card-feature-2">
                                        ...
                                        <div class="card-info"><a href="#">
                                                <h3 class="text-16-bold">Рост сотрудничества</h3>
                                            </a>
                                            <p class="text-md neutral-700">Откройте новые возможности для развития через
                                                нашу платформу</p>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="section-box wow animate__animated animate__fadeIn box-case-study-2 box-client-2">
            <div class="container">
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card-casestudy">
                                        ...
                                        <div class="card-desc">
                                            <p>Мы тщательно изучаем ваши запросы и цели, чтобы предложить подходящие
                                                решения. Это помогает определить оптимальные стратегии для достижения вашего
                                                успеха.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="card-casestudy">
                                        ...
                                        <div class="card-desc">
                                            <p>Мы разрабатываем уникальные стратегии и инструменты, которые соответствуют
                                                вашим требованиям. Каждый клиент для нас особенный.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="card-casestudy">
                                        ...
                                        <div class="card-desc">
                                            <p>Мы помогаем вам извлечь максимум из собранных данных, создавая эффективные
                                                отчёты и визуализацию для принятия обоснованных решений.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-7 text-center"><img src="assets/imgs/dora/partner-section.webp" alt="DORA">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="row align-items-center texts my-5">
                        <div class="col-lg-6">
                            ...
                            <p class="text-lg neutral-500">
                                Каждый месяц тысячи пользователей успешно находят, сравнивают и выбирают поставщиков услуг
                                            ...
                                            <defs>
                                                <clippath id="clip0_1_376">
                                                    <rect width="13" height="13" fill="white"
                                                        transform="translate(13.5 13)"></rect>
                                                </clippath>
                                            </defs>
                                        </svg>
                                    </span>
                        ...
                        <div class="col-lg-6">
                            <div class="box-image-neutral-1000">
                                <img src="assets/imgs/event.webp"
                                    alt="marketing"
