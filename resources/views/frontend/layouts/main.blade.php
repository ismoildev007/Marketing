                    ...
                    <div class="form-search p-20 dark">
                        ...
                        <div class="popular-keywords text-start mt-20">
                            <p class="mb-10 color-white">Популярные запросы:</p><a class="color-gray-600 mr-10 font-xs"
                                href="#">Платформа,</a><a class="color-gray-600 mr-10 font-xs" href="#">#
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-top">
                <div class="user-account">
                    ...
                    @endauth
                    {{-- <img src="/assets/imgs/page/homepage6/fast.png" alt="Профиль">
                    <div class="content">
            ...
            <div class="mobile-header-content-area">
                <div class="perfect-scroll h-auto">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 col-sm-12 mb-30"><a href="/"><img alt="Marketing"
                            src="/assets/imgs/template/marketing-white.png" style="height: 50px;"></a>
            ...
            <div class="footer-bottom mt-0">
                ...
                <div class="row mt-4 mb-20 align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="mt-3 d-flex justify-content-end align-items-center comp-logo-wrap">
                            <div class="footer__bottom__title__h5 mb-0">Создатель сайта</div>
                            <div class="comp-logo-wrap">
                                <img src="/assets/imgs/template/dora_small.svg" alt="DORA®"
                                    class="smaill-logo ms-3" width="25px" />
                                <img src="/assets/imgs/template/dora-logo.svg" alt="DORA®"
                                    class="comp-logo ms-3" />
                            </div>
                        </div>
                    </div>
                </div>
