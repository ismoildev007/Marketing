...
<html lang="en">
  ...
  <body>
    ...
    <header class="header header-style-2 header-style-4 sticky-bar">
      <div class="container">
        <div class="main-header">
          ...
          <div class="header-right d-block d-lg-none"><a class="btn btn-search hover-up" href="#"></a>
            <div class="form-search p-20 dark">
              ...
              <div class="popular-keywords text-start mt-20">
                <p class="mb-10 color-white">Популярные запросы:</p><a class="color-gray-600 mr-10 font-xs" href="#">Платформа,</a><a class="color-gray-600 mr-10 font-xs" href="#"># База данных,</a><a class="color-gray-600 mr-10 font-xs" href="#"># Цены</a>
              </div>
            </div>
        ...
        <div class="mobile-header-content-area">
          <div class="perfect-scroll">
            ...
            <div class="mobile-social-icon mb-50">
              ...
              <a class="icon-socials icon-facebook" href="#!"><img alt="Facebook" src="/assets/imgs/template/icons/fb.svg"></a>
              <a class="icon-socials icon-instagram" href="#!"><img alt="Instagram" src="/assets/imgs/template/icons/in.svg"></a>
              <a class="icon-socials icon-twitter" href="#!"><img alt="Twitter" src="/assets/imgs/template/icons/tw.svg"></a>
            </div>
    ...
    <footer class="footer footer-style-3 footer-style-5">
      <div class="container">
        <div class="row">
          <div class="col-md-5 col-sm-12 mb-30"><a href="/"><img alt="Marketing" src="/assets/imgs/template/marketing-white.png" style="height: 50px;"></a>
            <div class="mt-20 mb-20">
              <p class="text-md neutral-600 mb-10">Крупнейшее маркетинговое сообщество Узбекистана – объединяем бизнесы и услуги для вашего успеха</p>
            </div>
          </div>
        ...
        <div class="footer-bottom mt-0">
          <div class="row align-items-end">
            <div class="col-lg-6 mb-20">
              ...
              <p class="text-sm neutral-600 mb-20">Подпишитесь на наши обновления – советы, акции и возможности прямо на вашу почту</p>
