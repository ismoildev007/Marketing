    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">Kategoriyani tahrirlash</li>
            </ul>
        </div>
    </div>
    @if ($errors->any())
                    ...
                    <div class="card-body">
                        <form action="{{ route('categories.update', $category->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name_uz" class="form-control" id="name_uz" value="{{ old('name_uz', $category->name_uz) }}" placeholder="Kategoriyaning nomini kiriting" required>
                            </div>
                            <div class="mb-3">
                                <label for="name_ru" class="form-label">Kategoriyaning nomi (RU)</label>
                                <input type="text" name="name_ru" class="form-control" id="name_ru" value="{{ old('name_ru', $category->name_ru) }}" placeholder="Kategoriyaning nomini kiriting" required>
                            </div>
                            <div class="mb-3">
                                <label for="name_en" class="form-label">Kategoriyaning nomi (EN)</label>
                                <input type="text" name="name_en" class="form-control" id="name_en" value="{{ old('name_en', $category->name_en) }}" placeholder="Kategoriyaning nomini kiriting" required>
                            </div>
